...
class InprogressOrderNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'title' => ['en' => 'Order In-progress', 'ar' => 'Order In-progress'],
            'detail' => ['en' => 'Your order is now in progress', 'ar' => 'Your order is now in progress'],
            'action' => 'ORDER_IN_PROGRESS',
            'extras' => ['orderId' => $this->orderId, 'status' =>'in-progress' ]
        ];
    }
