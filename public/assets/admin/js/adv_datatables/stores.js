var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-stores").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/stores"}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "title_en", title: "Name",  width: 150},
                    {field: "email", title: "Email",  width: 200},
                    {field: "is_active", title: "Active",  width: 50},
                    {field: "email_verified", title: "Email Verified",  width: 150},
                    {field: "trade_license_verified", title: "Trade License Verified",  width: 150},
