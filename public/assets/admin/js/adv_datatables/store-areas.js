var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-store-areas").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/store-areas/"+storeId}},
                pageSize: 10,
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            $.ajax({
                                ...
                                .done(function(res){ toastr.success("Store Area deleted successfully!"); location.reload(); })
                                .fail(function(res){ toastr.success("Store Area Deleted  successfully!"); t.reload();  });
                        } else {
                            swal.close()
                        }
                    });
