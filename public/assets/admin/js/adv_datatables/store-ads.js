var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-store-ads").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/store-ads/"+storeId}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "title_en", title: "Title",  width: 150},
                    {field: "sub_title_en", title: "Sub Title",  width: 200},
                    {field: "ad_status", title: "Status",  width: 200},
        ...
        t.on('m-datatable--on-layout-updated', function(params){
            $('.delete-record-button').on('click', function(e){
                ...
                swal({
                        title: "Are you sure you want to change status of this ad?",
                        type: "warning",
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            $.ajax({
                                ...
                                .fail(function(res){
                                    toastr.success("Store Area Deleted  successfully!");
                                    t.reload();
                                });
                        } else {
                            swal.close()
