var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $("#manage-services").mDatatable({
            ...
            columns:
                [
                    ...
                    {field: "store", title: "Supplier",  width: 150},
                    {field: "title", title: "Title",  width: 150},
                    {field: "price", title: "Price",  width: 100},
                    {field: "has_offer", title: "Has Offer",  width: 50},
                    {field: "discount_percentage", title: "Discount",  width: 100},
        ...
        $("#store-reset").on("click", function (a) {
            console.log('it is in agency');
            a.preventDefault();
            var dataTable = t.getDataSourceQuery();
            dataTable.titleEn = '';
            dataTable.discountStatus = '';
            dataTable.activeStatus = '';

            $(this).closest('form').find("input[type=text]").find("select").val("");
