...
//    $width = $_GET['w'];
//    $height = $_GET['h'];
//    define('NOT_FOUND_IMAGE','https://via.placeholder.com/'.$width.'x'.$height.'?text=Placeholder+Image');
//}

if (!defined('NOT_FOUND_IMAGE')) define('NOT_FOUND_IMAGE', 'default-image.jpg');                            // Image to serve if any 404 occurs
...
//    $width = $_GET['w'];
//    $height = $_GET['h'];
//    define('ERROR_IMAGE', 'https://via.placeholder.com/'.$width.'x'.$height.'?text=Placeholder+Image');
//}
if (!defined('ERROR_IMAGE')) define('ERROR_IMAGE', 'default-image.jpg');                                // Image to serve if an error occurs instead of showing error message
...
//        if ($_SERVER['DOCUMENT_ROOT'] == 'C:/xampp-8.0/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'C:/xampp8.0.12/htdocs') {
//            define('LOCAL_FILE_BASE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'] . '\build-it-laravel\public');
//        } else {
//            define('LOCAL_FILE_BASE_DIRECTORY', 'C:\xampp-8.0\htdocs\build-it-laravel\public');
//        }
//    } else {
