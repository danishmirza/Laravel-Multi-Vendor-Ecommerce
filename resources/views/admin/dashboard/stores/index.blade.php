...
@push('script-page-level')
    ...
    <script src="{{asset('assets/admin/js/adv_datatables/stores.js')}}" type="text/javascript"></script>
@endpush
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" data-dropdown-toggle="hover" aria-expanded="true">
                            <a href="{!! route('admin.dashboard.stores.create') !!}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
        ...
        <div class="m-portlet__body">
            ...
            <!--end: Search Form -->
            <!--begin: Datatable -->
            <div class="manage-users" id="manage-stores"></div>
            <!--end: Datatable -->
        </div>
    </div>
