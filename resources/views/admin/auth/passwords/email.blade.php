...
@section('content')
    ...
    <div class="">
        ...
        <form class="m-login__form m-form" action="{!! route('admin.auth.forgot-password') !!}" method="post">
            ...
            <div class="m-login__form-action">
                ...
                <a href="{!! route('admin.auth.login.form') !!}" id="m_login_forget_password_cancel" class="btn m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn">
