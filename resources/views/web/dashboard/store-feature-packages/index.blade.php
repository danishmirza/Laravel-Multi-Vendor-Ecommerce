            ...
            <div class="profile-sub-tab package-tabs-outer">
                <ul class="nav nav-pills mb-3 profile-tabs profile-tabs-sub justify-content-center" id="sub-tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active">All Packages</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" href="{{route('web.dashboard.feature-packages.purchased')}}">Purchased Packages</a>
                    </li>
                </ul>
                <div class="tab-content profile-tabs-content">
                    <div class="tab-pane fade show active">
                        <div class="user-profile subscription-wrap">
                            <div class="row">
                                ...
                                @empty
                                   <div class="col-12">
                                       @include('web.common.not-found', ['message' => 'No feature packages available.'])
                                   </div>
                                @endforelse
                                    {!! $packages->render() !!}
                            </div>
