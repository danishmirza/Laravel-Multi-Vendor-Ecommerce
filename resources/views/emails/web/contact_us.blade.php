        ...
        <tr>
            <td align="center">
                <table width="90%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td class="content" valign="top" align="left"
                            style="font-size:24px;font-weight: 500;color:#333;line-height:32px; padding-left:30px;padding-right:30px">{!! $name !!}
                            Left a Message
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-left:30px;padding-right:30px">
                            <table width="100%" cellpadding="12" cellspacing="0" border="0"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $name !!}</td>
                                </tr>
                                <tr>
                                    <td valign="center" align="left"
                    ...
                    <tr>
                        <td valign="top" align="left" style="padding-left:30px;padding-right:30px"><h2
                                style="margin-bottom: 0px;">{!! config('projects.settings.project_name') !!}</h2></td>
                    </tr>
                    </tbody>
                </table>
            </td>
